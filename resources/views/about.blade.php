            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-12 about-text">
                        <div class="title">
                            «ИстокиЯ» — всё начинается с Истока, всё возвращается к Я.
                        </div>
                        <div class="desc mt-3">
                            «Исток» — про внутренний ресурс и восстановление, «Я» — про осознанность и заботу о себе.
                        </div>
                        <div class="desc mt-3">
                            Это то место, где помогают возвращаться в баланс через комплексную работу с телом, духом и
                            психикой. Пространство создано с душой и любовью людьми, которые прочувствовали эффект от
                            регулярных практик на себе.
                        </div>
                        <div class="desc mt-3">
                            В «ИстокиЯ» более 15 направлений групповых занятий для взрослых и детей: это йога и
                            аэройога, медитации, пилатес, растяжка, фейсфитнес, а также более динамичные тренировки,
                            такие как зумба и джампинг на батутах.
                        </div>
                        <div class="desc mt-3">
                            Для вас: два больших зала, массажный кабинет, чайная зона и услуги психолога.<br>
                            В центре проводятся различные мастер-классы, корпоративные занятия и выездные практики на
                            собственном автобусе. Всё продумано для того, чтобы вы могли возвращаться к своему Истоку.
                        </div>
                    </div>
                </div>
            </div>
